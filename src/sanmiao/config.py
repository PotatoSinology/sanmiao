...
phrase_dic_en = {
    ...
    'insuff-data': 'Insufficient data: please add a ruler or era',
    ...
    'lp-gz-day-mismatch': 'Lunar phase-gz-day mismatch; ',
...
phrase_dic_fr = {
    ...
    'insuff-data': 'Données insuffisantes : veuillez ajouter un souverain ou une ère',
    'too-many-cand': 'candidats. Veuillez affiner la plage de dates.',
    'year-lun-mismatch': 'Incompatibilité année-lunaison',
    'year-sex-mismatch': 'Incompatibilité année-année sex.',
    'dyn-rul-era-mismatch': 'Incompatibilité dyn-souv-ère ; ',
    'year-month-mismatch': 'incompatibilité année-mois ; ',
    'year-int-month-mismatch': 'Incompatibilité année-mois int. ; ',
    'lp-gz-day-mismatch': 'Incompatibilité phase lun.-gz-jour ; ',
